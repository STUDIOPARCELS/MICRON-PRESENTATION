...
function App() {
  ...
  return (
    <div className="min-h-screen w-full bg-white text-zinc-900 font-sans">
      ...
      <nav className="fixed top-0 left-0 right-0 z-[100] flex items-center justify-between bg-white/95 backdrop-blur-xl px-6 md:px-12 py-5 border-b border-zinc-200 shadow-sm transition-all duration-300">
        <div 
